...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['password', 'required', 'message' => 'É obrigatório preencher a palavra-passe!', 'on' => 'create'],
            ...
            ['confirmarpassword', 'required', 'message' => 'É obrigatório preencher o confirmar palavra-passe!', 'on' => 'create'],
